...
It selects from 5 available sizes ranging from 80px up to full size.
...
3. (optional) Replace all calls to `<?php the_thumbnail(); ?>` with `<?php the_thumbnail('responsive-base'); ?>` in your theme files.

== Frequently Asked Questions ==

= Does this plugin work with any theme? =

No, your theme must support post thumbnails and use the_thumbnail appropriatly.
